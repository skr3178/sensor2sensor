...
`[3, H, W]` tensor in [0, 1] ready for the VAE.
...
class WaymoLidarTopKeyframes(Dataset):
    ...
    Args:
        ...
        range_max_m, intensity_max: normalization constants forwarded to
            `waymo_range_image_to_3ch`.
    ...
    Each item is a `[3, H_out, W_out]` float32 tensor in [0, 1].
    """
